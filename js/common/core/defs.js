...
window.GAS_API_BASE =
  window.GAS_API_BASE ||
  'https://script.google.com/macros/s/AKfycbz-iOiP8rt0xdKq-AKhzjpDz4OVaTbJgDfezWiiC0LKhSUP8G5UGaVt2pSAOY5-tKoy/exec';
...
window.CATEGORY_GROUPS ??= [
    ...
    { race: 'シェイド',   list: ["昏き霊園（スレイヴヤード）","マディスキア","炎閻魔（えんえんま）","ヴァントム","ヴォルグリム"] },
    // ノーカテゴリは race なし
];
